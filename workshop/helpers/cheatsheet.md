...
# Turn off Docker
> Docker is know to cause problems with the Android emulator, 
since Flutter uses Dart VM. 

# Java versions
> Use SDKMan to easily switch between Java versions, 
it is preferable to use Java 8 to avoid problems
